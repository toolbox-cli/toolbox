...
Launch Terraform 1.15.3 via an executable docker container.
...
_See code: [src/commands/hashicorp/ansible/0.0.1.ts](https://github.com/toolbox-cli/toolbox/blob/v0.0.4/src/commands/hashicorp/ansible/0.0.1.ts)_
